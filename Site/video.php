		...
		<div class="container">
			<div class="page-content">
			   <div class="page-content">
			          ...
			          <div class="col-md-8">
			            <div class="blog-list">
			              <p class="t_tex"> Video / Category Name</p>
			              <div class="bx">			                 
			                <div class="col-md-4">
			                	<a href="full_video.php">
			                		<iframe width="220" height="125" src="https://www.youtube.com/embed/aGe9Hr_9YEU" frameborder="0" allowfullscreen>
			                		</iframe>
			                	</a>
			                </div>
			                <div class="col-md-8">
			                	<p class="post"><b>Title :</b> Freedom 251 First Look - World's First $4 Smartphone</p>
			                	<p class="post"><b>Category Name :</b> Mobile</p>
			                	<p class="post"><a href="view_video.php">view</a></p>
			                </div>
			              </div>
